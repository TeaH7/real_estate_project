...
@section('admin_content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Create Property</h4>
                                ...
                                <div class="col-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            id="defaultFormControlInput" placeholder="Apartment"
                                            aria-describedby="defaultFormControlHelp" name="type_of_property"
                                ...
                                <div class="col-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control @error('price') is-invalid  @enderror"
                                            id="defaultFormControlInput" placeholder="Euro"
                                ...
                                <div class="col-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('address') is-invalid  @enderror"
                                            id="defaultFormControlInput" placeholder="RR. Don Bosko"
                                ...
                                <div class="col-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number"
                                            ...
                                            id="defaultFormControlInput" placeholder="1"
                                            aria-describedby="defaultFormControlHelp" name="nr_of_beds"
                                ...
                                <div class="col-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number"
                                            ...
                                            id="defaultFormControlInput" placeholder="2"
                                            aria-describedby="defaultFormControlHelp" name="nr_of_baths"
                                ...
                                <div class="col-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control @error('area') is-invalid  @enderror"
                                            id="defaultFormControlInput" placeholder="120"
                                            aria-describedby="defaultFormControlHelp" name="area"
                                            value="{{ old('area') }}" />
                                        @error('area')
                                            <div class="invalid-feedback">
                                                {{ $message }}
